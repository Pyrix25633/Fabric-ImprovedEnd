...
public class BraniusBodyBlock extends AbstractPlantBlock implements Fertilizable, Branius {
    public BraniusBodyBlock(Settings settings) {
        super(settings, Direction.DOWN, SHAPE, false);
        this.setDefaultState((this.stateManager.getDefaultState()).with(BERRIES, false));
    }

    protected AbstractPlantStemBlock getStem() {
        return (AbstractPlantStemBlock) ModBlocks.BRANIUS;
    }
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModItems.BRANIUS_BERRIES);
    }
