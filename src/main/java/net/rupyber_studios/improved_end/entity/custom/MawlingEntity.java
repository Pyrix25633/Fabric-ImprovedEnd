...
public class MawlingEntity extends HostileEntity implements IAnimatable, Angerable {
    ...
    public MawlingEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        if (this.isAttacking()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.mawling.attack", true));
    ...
    static {
        ...
        ANGRY = DataTracker.registerData(MawlingEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
        PROVOKED = DataTracker.registerData(MawlingEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
        ANGER_TIME_RANGE = TimeHelper.betweenSeconds(20, 39);
    }

    static class ChasePlayerGoal extends Goal {
        private final MawlingEntity enderman;
        @Nullable
        private LivingEntity target;

        public ChasePlayerGoal(MawlingEntity enderman) {
    ...
    static class TeleportTowardsPlayerGoal extends ActiveTargetGoal<PlayerEntity> {
        ...
        public TeleportTowardsPlayerGoal(MawlingEntity enderman, @Nullable Predicate<LivingEntity> targetPredicate) {
